...
import { getPassTheAuxPresenterTypeHelper } from "../models/PresenterModel";
import { getPassTheAuxClientTypeHelper } from "../models/ClientModel";
...
// Main Game Page
// -------------------------------------------------------------------
export default class PassTheAuxGameComponent extends ClusterfunGameComponent {
  // -------------------------------------------------------------------
  // ctor
  // -------------------------------------------------------------------
