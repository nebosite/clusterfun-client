...
import {
  TestatoColorChangeActionEndpoint,
  TestatoMessageActionEndpoint,
  TestatoOnboardClientEndpoint,
  TestatoTapActionEndpoint,
} from "./testatoEndpoints";
...
export class TestatoClientModel extends ClusterfunClientModel {
  ballData = { x: 0.5, y: 0.5, xm: 0.01, ym: 0.01, color: "#ffffff" };
  ...
  doMessage() {
    ...
    this.session.sendMessageToPresenter(TestatoMessageActionEndpoint, {
