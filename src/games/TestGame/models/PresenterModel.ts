...
export const getTestatoPresenterTypeHelper = (
  ...
  return {
    ...
    getTypeName(o) {
      switch (o.constructor) {
        case TestatoPresenterModel:
          return "TestatoPresenterModel";
        case TestatoPlayer:
          return "TestatoPlayer";
      }
      return undefined;
    },
    constructType(typeName: string): any {
      switch (typeName) {
        case "TestatoPresenterModel":
          return new TestatoPresenterModel(sessionHelper, gameProps.logger, gameProps.storage);
        case "TestatoPlayer":
          return new TestatoPlayer();
