...
import { getCollageBoardPresenterTypeHelper } from "../models/PresenterModel";
import { getCollageBoardClientTypeHelper } from "../models/ClientModel";
...
// Main Game Page
// -------------------------------------------------------------------
export default class CollageBoardGameComponent extends ClusterfunGameComponent {
  // -------------------------------------------------------------------
  // ctor
  // -------------------------------------------------------------------
  constructor(props: ClusterFunGameProps) {
    ...
    this.init(
      ...
      getCollageBoardClientTypeHelper,
    );
  }
}
