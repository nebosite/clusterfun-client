...
export const RetroSpectroStatePushEndpoint: MessageEndpoint<RetroSpectroStateUpdateResponse, void> =
  {
...
export const RetroSpectroDiscussionEndpoint: MessageEndpoint<RetroSpectroDiscussionMessage, void> =
  {
