...
const answerCollectionSpacerDropSpec = {
  drop(
    props: AnswerCollectionSpacerProps,
    monitor: DropTargetMonitor,
    component: AnswerCollectionSpacer,
  ) {
...
//
// -------------------------------------------------------------------
const answerCollectionSpacerDropCollect = (
...
// -------------------------------------------------------------------
@observer
class AnswerCollectionSpacer extends React.Component<AnswerCollectionSpacerProps> {
  render() {
    const { connectDropTarget, hoveredOnSelf } = this.props;
    const spacerStyle = hoveredOnSelf ? { width: "120px" } : { width: "10px" };
...
export default DropTarget(
  "*",
  answerCollectionSpacerDropSpec,
  answerCollectionSpacerDropCollect,
)(AnswerCollectionSpacer);
