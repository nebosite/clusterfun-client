...
import { getMixtapePresenterTypeHelper } from "../models/PresenterModel";
import { getMixtapeClientTypeHelper } from "../models/ClientModel";
...
// Main Game Page
// -------------------------------------------------------------------
export default class MixtapeGameComponent extends ClusterfunGameComponent {
  // -------------------------------------------------------------------
  // ctor
  // -------------------------------------------------------------------
  constructor(props: ClusterFunGameProps) {
    ...
    this.init(lazyPresenter, lazyClient, getMixtapePresenterTypeHelper, getMixtapeClientTypeHelper);
  }
}
