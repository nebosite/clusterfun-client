  ...
  return {
    ...
    getTypeName(o: object) {
      switch (o.constructor) {
        case StressatoPresenterModel:
          return "StressatoPresenterModel";
        case StressatoPlayer:
          return "StressatoPlayer";
      }
      return undefined;
    },
    constructType(typeName: string): any {
      switch (typeName) {
        case "StressatoPresenterModel":
          return new StressatoPresenterModel(sessionHelper, gameProps.logger, gameProps.storage);
        case "StressatoPlayer":
          return new StressatoPlayer();
...
export class StressatoPresenterModel extends ClusterfunPresenterModel<StressatoPlayer> {
  ...
  set serverHealth(value) {
    action(() => {
      this._serverHealth = value;
    })();
  }
  ...
  reconstitute() {
    ...
    this.listenToEndpoint(
      StressatoPresenterRelayWithoutReturnEndpoint,
      this.handleRelayWithoutReturn,
    );
  }
