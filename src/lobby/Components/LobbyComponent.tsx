    ...
    return (
      <div className={styles.gmMenu}>
        <div className={styles.gmContainer}>
          {" "}
          <img src={LobbyAssets.images.logos.clusterFun} alt="" />{" "}
        </div>
            ...
            .map((game) => (
              <li key={game.name}>
                <div className={styles.btnContainer}>
                  <img
                    alt={`Start ${game.displayName ?? game.name}`}
                    src={game.logoName}
...
@inject("lobbyModel")
@observer
class GameClientComponent extends React.Component<{ lobbyModel?: LobbyModel }> {
  //--------------------------------------------------------------------------------------
  //
  //--------------------------------------------------------------------------------------
  render() {
    ...
    return (
      <div className={classNames(styles.lobby)}>
        {lobbyModel.lobbyErrorMessage ? (
          <div className={classNames(styles.errorMessage)}>{lobbyModel.lobbyErrorMessage} </div>
        ) : null}
        <div className={classNames(styles.divRow)}>
          <div className={styles.lobby}>
            <div className={styles.logo}>
              <img
                src={LobbyAssets.images.logos.clusterFun}
                alt="logo"
