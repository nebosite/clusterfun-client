...
export class ClusterCanvas extends React.Component<ClusterCanvasProps> {
  ...
  handleMouseUp = (event: React.MouseEvent) => {
    ...
    if (timeDelta < 50 || this.moveDelta < 30) {
      Logger.debug(
        `Click: ${x.toFixed(0)},${y.toFixed(0)} <${event.clientX.toFixed(0)},${event.clientY.toFixed(0)}> [${this.canvasScreenOffset.left.toFixed(0)},${this.canvasScreenOffset.top.toFixed(0)}] (${this.mouseWidth.toFixed(0)},${this.mouseHeight.toFixed(0)})`,
      );
