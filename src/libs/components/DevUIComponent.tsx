...
export class DevUI extends React.Component<DevUIOptions> {
  ...
  render() {
    ...
    return (
      <DevOnly
        style={{ paddingLeft: "50x", background: "black", fontSize: "70%", ...this.props.style }}
      >
        <button
          style={{
            marginRight: "10px",
            padding: "5px",
            marginLeft: "10px",
            background: context.devFast ? "yellow" : "darkGray",
          }}
        ...
        <button
          style={{
            marginRight: "10px",
            padding: "5px",
            background: context.devPause ? "yellow" : "darkGray",
          }}
