...
export interface ISessionHelper {
  ...
  sendMessageToPresenter<MESSAGE>(endpoint: MessageEndpoint<MESSAGE, void>, message: MESSAGE): void;
...
export class SessionHelper implements ISessionHelper {
  ...
  public get personalId() {
    return this._messageThing.personalId;
  }
  public get personalSecret() {
    return this._messageThing.personalSecret;
  }
  ...
  listenPresenter<REQUEST, RESPONSE>(
    ...
    return new ClusterfunListener<REQUEST, RESPONSE>(
      endpoint,
      this._messageThing,
      (sender: string, value: REQUEST) => {
